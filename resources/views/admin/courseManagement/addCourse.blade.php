                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="txt_description" name="txt_description" rows="4" placeholder="Enter description" value="{!! old('txt_description') !!}" pattern="^[a-zA-Z_ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶ
                    ẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợ
                    ụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ\\s]{1,255}+$" required></textarea>
                    </div>
                    <div class="form-group">
                      <label>Term</label>
                      <select id="cmb_term" name="cmb_term" class="form-control" required value="{!! old('cmb_term') !!}">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group" id="wrapper">
                      ...
                      {{-- <div > --}}
                       <input name="image" type="file" accept="image/*" required onchange="preview_image(event)">
