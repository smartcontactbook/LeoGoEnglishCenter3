        ...
        <form action="{{ route('postRegisterOnline') }}"  method="POST" id="addRegisterOnline">
          ...
          <div class="contact-signup-content">
            <div class="input-block clearfix">
              ...
              <input type="text" class="half-w right txtDateofBirth o2o-birthday" name="txt_date" title="Bạn chưa nhập ng&#224;y sinh " placeholder="Ngày tháng năm sinh(dd/mm/yyyy)*">
            </div>
            <div class="input-block clearfix">
            ...
            <div class="input-block clearfix">
              ...
              <input type="text" class="half-w right txtPhone o2o-phone" name="txt_phone" title="Bạn chưa nhập số điện thoại" data-text-invalid="Kh&#244;ng đ&#250;ng định dạng số điện thoại" placeholder="Số điện thoại*" maxlength="10" pattern="(09|03|04|07|08|05)+([0-9]{8})\b" required>
            </div>
            <div class="input-block clearfix">
