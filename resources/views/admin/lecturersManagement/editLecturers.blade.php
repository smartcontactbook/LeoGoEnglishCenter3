...
@section('main-content')
	...
	<section class="content">
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<form method="POST" action="{!! route('postUpdateLecturer', $getLecturer->id) !!}" enctype="multipart/form-data">
						{!! csrf_field() !!}
							...
							<div class="col-sm-4">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<fieldset class="form-group"><input type="text" id="txt_phone" class="form-control" placeholder="Phone" maxlength="10" pattern="(09|03|04|07|08|05)+([0-9]{8})\b" required title="Invalid format phone number"  name="txt_phone" value="{!! old('txt_phone', $getLecturer->Phone_Number) !!}">
										</fieldset>
									</div>
									<div class="form-group">
								...
								<div class="box-body">
									<div class="avatar-upload">
	                                    <div class="avatar-edit">
	                                        {!! Form::hidden('old_avatar', $getLecturer->avatar) !!}
	                                        {!! Form::file('new_avatar', ['id' => 'imageUpload', 'accept' => '.png, .jpg, .jpeg']) !!}
	                                        {!! Form::label('imageUpload', ' ') !!}
	                                    </div>
	                                    <div class="avatar-preview">
	                                        <div id="imagePreview">
	                                            <img src="{{ asset('image/avatar').'/'.$getLecturer->avatar }}">
	                                        </div>
	                                    </div>
	                                </div>
								</div>
