			...
			<div class="box">
				...
				<div class="box-header">
					<p class="pull-right box-title">
						...
						<a href="{{ route('staff.create') }}"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>Add</button></a>
					</p>
				</div>
						...
						<tbody>
							...
							<?php $stt=$stt+1 ?>
								<tr>
									...
									<td>{{$value->Address}}</td>
									<th>
										<a href="{{ route('staff.edit', $value->id) }}"><button type="button" class="btn btn-warning editLeftRight"><i class="	fa fa-edit"></i></button></a>
