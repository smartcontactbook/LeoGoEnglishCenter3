    ...
    <section class="content">
      ...
      <div class="row">
		...
		@else
		 ...
		 <div class="box box-primary">
			<div class="box-body box-profile">
				<img class="profile-user-img img-responsive img-circle" src="{{ asset('image/avatar').'/'.Auth::guard('children')->user()->avatar }}" alt="User profile picture">

				<h3 class="profile-username text-center">{{Auth::guard('children')->user()->Full_Name }}</h3>
				...
				<ul class="list-group list-group-unbordered">
					<li class="list-group-item">
						<b>Email</b> <a class="pull-right">{{Auth::guard('children')->user()->email }}</a>
					</li>
					<li class="list-group-item">
						<b>Birth Day</b> <a class="pull-right">{{Auth::guard('children')->user()->Birth_Day }}</a>
					</li>
					<li class="list-group-item">
						<b>Phone Number</b> <a class="pull-right">{{Auth::guard('children')->user()->Phone_Number }}</a>
					</li>
					<li class="list-group-item">
						<b>Gender</b> <a class="pull-right">
							@if(Auth::guard('children')->user()->Gender == 1)
								Male
							@else
								Female
							@endif
					...
					<li class="list-group-item">
						<b>Address</b> <a class="pull-right">{{Auth::guard('children')->user()->Address }}</a>
					</li>
				</ul>
			</div>
			<!-- /.box-body -->
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<p class="text-muted">
					{{Auth::guard('children')->user()->Description }}
				</p>
				<hr>
			</div>
			<!-- /.box-body -->
	...
	<div class="col-md-9">
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
				<div class="active tab-pane" id="activity">
					<form method="post" action="{{ route('postProfile') }}" enctype="multipart/form-data" class="form-horizontal">
						<input type="hidden" name="id_staff" value="{{Auth::guard('children')->user()->id}}">
						{{csrf_field()}}
						@include('errors.errors')
						<div class="row">
							<div class="col-sm-8">
								<div class="box-body">
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											id="txt_FirstName"
											name="txt_FirstName"
											value="{!! old('txt_FirstName', Auth::guard('children')->user()->Full_Name) !!}"
											type="text"
											class="form-control"
											placeholder="Enter first name"
											required pattern="^[a-zA-Z]*$" title="First name invalid"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											id="txt_LastName"
											name="txt_LastName"
											value="{!! old('txt_LastName', Auth::guard('children')->user()->Nick_Name) !!}"
											type="text"
											class="form-control"
											placeholder="Enter Last Name"
											required pattern="^[a-zA-Z]*$" title="Last name invalid"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="txt_email" class="form-control" placeholder="Emaill" required pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$" title="Email Format Invalid" name="txt_email" value="{!! old('txt_email', Auth::guard('children')->user()->email) !!}">
										</div>
									</div>
									<div class="form-group">
										<label for="inputName" class="col-sm-2 control-label">BirthDay</label>
										...
										<div class="col-sm-10">
											<div class="input-group date" data-provide="datepicker">
												...
												<input type="text" class="form-control" id="txt_date" name="txt_date" value="{!! old('txt_date', Auth::guard('children')->user()->Birth_Day) !!}">
											</div>
										</div>
									</div>
									<div class="form-group">
										<label for="inputExperience" class="col-sm-2 control-label">Phone</label>
										<div class="col-sm-10">
											<fieldset ><input type="text" id="txt_phone" class="form-control" placeholder="Phone" maxlength="10" pattern="(09|03|04|07|08|05)+([0-9]{8})\b" required title="Invalid format phone number"  name="txt_phone" value="{!! old('txt_phone', Auth::guard('children')->user()->Phone_Number) !!}">
											</fieldset>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="txt_address" class="form-control" required placeholder="Address"
											name="txt_address" value="{!! old('txt_address', Auth::guard('children')->user()->Address) !!}">
										</div>
									</div>
									<div class="form-group">
										<label for="inputSkills" class="col-sm-2 control-label">Description</label>
										<div class="col-sm-10">
											<textarea id="txt_description" rows="3" class="form-control" name="txt_description" placeholder="Enter Description" required>{!!old('txt_description',Auth::guard('children')->user()->Description) !!}</textarea>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="box-body">
									<div class="avatar-upload">
										<div class="avatar-edit">
											{!! Form::hidden('old_avatar', Auth::guard('children')->user()->avatar) !!}
											{!! Form::file('new_avatar', ['id' => 'imageUpload', 'accept' => '.png, .jpg, .jpeg']) !!}
											{!! Form::label('imageUpload', ' ') !!}
										</div>
										<div class="avatar-preview">
